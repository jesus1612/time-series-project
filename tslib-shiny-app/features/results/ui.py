    ...
    return create_card(
        ...
        content=ui.div(
            ...
            ui.div(
                ...
                ui.tags.p(
                    "Barras interactivas (zoom). ARIMA, AR, MA y ARMA: lineal, paralelo total, warm-up Spark y distribución del DataFrame de tareas; otros modelos: lineal vs paralelo.",
